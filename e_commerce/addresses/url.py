...
from e_commerce.addresses.view import address_data,get_address, update_address, delete_address, shipping_address_data, get_ship_address, update_shipping_address, delete_shipping_address
